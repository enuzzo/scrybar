...
struct UiStrings {
    ...
    // GPT panel
    const char* gptRecording;         // audio recording in progress
    const char* gptProcessing;        // pipeline running, waiting for reply
    const char* gptSystemPrompt;      // system message injected into OpenAI request
    // Touch hints
...
static const UiStrings kUiLang_it = {
    ...
    /* gptRecording         */ "Registrazione in corso...\nTocca per fermare.",
    /* gptProcessing        */ "Elaboro la richiesta...\nAttendi un attimo.",
    /* gptSystemPrompt      */ "Rispondi in italiano naturale. Se richiesto un numero random, scegline uno diverso. Citazioni brevi, non troncare frasi.",
...
static const UiStrings kUiLang_en = {
    ...
    /* gptRecording         */ "Recording...\nTap to stop.",
    /* gptProcessing        */ "Processing request...\nPlease wait.",
    /* gptSystemPrompt      */ "Reply in natural English. If asked for a random number, choose a different one. Brief quotes, do not truncate sentences.",
...
static const UiStrings kUiLang_fr = {
    ...
    /* gptRecording         */ "Enregistrement...\nTouchez pour arreter.",
    /* gptProcessing        */ "Traitement en cours...\nPatientez.",
    /* gptSystemPrompt      */ "Reponds en francais naturel. Si un nombre aleatoire est demande, choisis-en un different. Citations breves, ne tronque pas les phrases.",
...
static const UiStrings kUiLang_de = {
    ...
    /* gptRecording         */ "Aufnahme laeuft...\nTippen zum Stoppen.",
    /* gptProcessing        */ "Anfrage wird bearbeitet...\nBitte warten.",
    /* gptSystemPrompt      */ "Antworte auf naturlichem Deutsch. Bei Zufallszahlen eine andere waehlen. Kurze Zitate, Saetze nicht abschneiden.",
...
static const UiStrings kUiLang_es = {
    ...
    /* gptRecording         */ "Grabando...\nToca para detener.",
    /* gptProcessing        */ "Procesando solicitud...\nEspera.",
    /* gptSystemPrompt      */ "Responde en espanol natural. Si se pide un numero aleatorio, elige uno diferente. Citas breves, no truncar frases.",
...
static const UiStrings kUiLang_pt = {
    ...
    /* gptRecording         */ "Gravando...\nToque para parar.",
    /* gptProcessing        */ "Processando pedido...\nAguarde.",
    /* gptSystemPrompt      */ "Responde em portugues natural. Se pedido um numero aleatorio, escolhe um diferente. Citacoes breves, nao truncar frases.",
...
static const UiStrings kUiLang_la = {
    ...
    /* gptRecording         */ "Colloquium notatur...\nTange ut sistas.",
    /* gptProcessing        */ "Petitio tractatur...\nExpecta paululum.",
    /* gptSystemPrompt      */ "Latine responde. Si numerus fortuitus rogatur, alium elige. Breve cita, sententias ne trunces.",
...
static const UiStrings kUiLang_eo = {
    ...
    /* gptRecording         */ "Registrado...\nTusu por haltigi.",
    /* gptProcessing        */ "Peto pritraktata...\nAtendу.",
    /* gptSystemPrompt      */ "Respondu en natura Esperanto. Se hazarda nombro estas petita, elektu alian. Mallongaj citajhoj, ne tranchu frazojn.",
...
static const UiStrings kUiLang_nap = {
    ...
    /* gptRecording         */ "Sto registranno...\nTocca pe' fferma'.",
    /* gptProcessing        */ "Sto elaboranno...\nAspetta nu poco.",
    /* gptSystemPrompt      */ "Rispunne in napoletano naturale. Si chiedono numeri a caso, scegline uno diverso. Citazioni brevi, non troncare frasi.",
...
static const UiStrings kUiLang_tlh = {
    ...
    /* gptRecording         */ "jatlhtaH...\nmevmeH yI'uch.",
    /* gptProcessing        */ "nob ngeHtaH...\nyIloS.",
    /* gptSystemPrompt      */ "tlhIngan Hol yIjatlh. mI' potlh tu'lu'chugh, latlh yIwIv. mu' nap lo', mu'tlhegh yIghItlh.",
