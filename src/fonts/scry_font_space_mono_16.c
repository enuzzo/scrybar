 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --size 16 --bpp 4 --no-compress --format lvgl --lv-include lvgl.h --font assets/fonts/SpaceMono-Regular.ttf -r 0x20-0x7E --lv-fallback lv_font_montserrat_16 --lv-font-name scry_font_space_mono_16 -o src/fonts/scry_font_space_mono_16.c
 ******************************************************************************/
...
#ifndef SCRY_FONT_SPACE_MONO_16
#define SCRY_FONT_SPACE_MONO_16 1
#endif

#if SCRY_FONT_SPACE_MONO_16
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t scry_font_space_mono_16 = {
#else
lv_font_t scry_font_space_mono_16 = {
#endif
...
#endif /*#if SCRY_FONT_SPACE_MONO_16*/
