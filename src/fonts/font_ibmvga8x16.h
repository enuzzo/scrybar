#pragma once
// IBM VGA 8x16 font, public domain (from Linux kernel lib/fonts/font_8x16.c)
// 256 glyphs × 16 rows = 4096 bytes. MSB = leftmost pixel. CP437 encoding.
static const uint8_t kIbmVga8x16[4096] = {
